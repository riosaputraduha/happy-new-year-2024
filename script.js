window.onload = function () {
  ...
  function init() {
    (canvas = document.getElementById("canvas")), (context = canvas.getContext("2d")), resize();
  ...
  function onEnterFrame() {
    ...
    while (--i > -1) {
      ...
      context.moveTo(particle.x + Math.cos(start) * outerRadius, particle.y - Math.sin(start) * outerRadius);
